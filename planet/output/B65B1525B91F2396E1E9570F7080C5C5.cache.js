...
function fF(){}
_=fF.prototype=new qx();_.Ee=cI+'ParseException';_.De=70;function jF(c,a,b){c.d=b;a.wb('id');c.f=a.wb('url');c.c=a.wb('date');c.a=a.wb('author');c.e=eF(a,'post-title');c.b=eF(a,'content-plain');return c;}
...
function uF(){}
_=uF.prototype=new ky();_.Ee=cI+'Subscriptions';_.De=0;_.a=null;function wF(c,a,b){c.b=a.wb('name');c.d=a.wb('url');c.a=a.wb('htmlUrl');c.c=a.wb('title');a.wb('faceUrl');a.wb('faceWidth');a.wb('faceHeight');a.wb('message');return c;}
function vF(){}
